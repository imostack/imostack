...
I came to engineering through design, which is probably why I can't ship an ugly thing in good conscience. Six years in, the part I still like most is the small stuff: a form that stops fighting the user, a page that loads before anyone notices it's loading, a flow that just… works, and nobody writes in to complain about it. That silence is the whole job.

---

## App Guts

I'm building **App Guts**, a SaaS company where I make practical tools for businesses. No moonshots. Just software that earns its place on someone's screen.
...
**Infrastructure** — Docker, Jenkins, Kubernetes, Linux, AWS, Vercel
